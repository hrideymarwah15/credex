...
import { ArrowRight, CheckCircle2, TrendingDown, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-8">
        ...
        {isOptimal ? (
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-zinc-700 dark:text-zinc-300">
              That's <strong>{formatUsd(totalAnnualSavings)}/year</strong> back in your
              runway. From {formatUsd(totalCurrentMonthly)}/mo →{" "}
              {formatUsd(totalRecommendedMonthly)}/mo.
            </p>
          </div>
        )}
      </section>
      ...
      <section className="space-y-3">
        ...
        {findings.map((f, i) => (
          <div
            key={i}
            className={`rounded-xl border p-5 ${severityStyle[f.severity]}`}
          >
